 ...
 * argument generation.
 *
 * If all num tests succeed, the function outputs a success string and
 * returns 0. If argument generation fails maxFail time before a success
 ...
 *
 * @param num Number of successful test to perform
 * @param maxFail Maximum number of unsuccessful argument generation
 *               (i.e. unsatisfied implication precondition)
 * @param prop Property to test
 * @param genNum Number of generators specified as vararg
